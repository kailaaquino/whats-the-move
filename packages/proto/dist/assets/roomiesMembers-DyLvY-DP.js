import{i as p,x as l,r as m,a as f,d as w,b as k}from"./reset.css-GlY_cqLy.js";import{N as P}from"./nav-bar-BGzyEcHL.js";import{n as d}from"./property-BE6-Eo5M.js";import{r as _}from"./state-_RpdubKC.js";import{F as j}from"./friend-nav-CMvY1LuW.js";import{P as b}from"./page-header-CHf9jBse.js";var O=Object.defineProperty,z=(i,t,r,u)=>{for(var e=void 0,a=i.length-1,s;a>=0;a--)(s=i[a])&&(e=s(t,r,e)||e);return e&&O(t,r,e),e};const v=class v extends p{constructor(){super(...arguments),this.initial=""}render(){return l` <div class="circle">${this.initial}</div> `}};v.styles=[m.styles,f`
      .circle {
        display: flex;
        width: 62px;
        height: 62px;
