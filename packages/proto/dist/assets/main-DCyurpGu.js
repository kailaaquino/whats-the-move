import{i as p,x as l,r as m,a as v,n as i,d as x}from"./property-BffYu5Uq.js";import{N as y}from"./nav-bar-dHfWQa5T.js";import{r as b}from"./state-BroQ6gKo.js";document.body.addEventListener("theme:toggle",s=>{const r=s.detail.checked;document.body.classList.toggle("light-mode",r)});var w=Object.defineProperty,n=(s,r,t,u)=>{for(var e=void 0,a=s.length-1,c;a>=0;a--)(c=s[a])&&(e=c(r,t,e)||e);return e&&w(r,t,e),e};const f=class f extends p{constructor(){super(...arguments),this.groupName="",this.members="",this.upcoming="",this.href="",this.plansHref="",this.membersHref=""}render(){return l`<div class="card-container">
